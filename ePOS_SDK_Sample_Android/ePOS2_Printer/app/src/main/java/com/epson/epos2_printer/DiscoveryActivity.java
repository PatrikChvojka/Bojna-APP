...
public class DiscoveryActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private ArrayList<DeviceInfo> mDeviceInfoList = null;
    private ArrayList<HashMap<String, String>> mSimpleAdapterData = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSimpleAdapterData = new ArrayList<HashMap<String, String>>();
        mPrinterListAdapter = new SimpleAdapter(this, mSimpleAdapterData, R.layout.list_at,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String ipAddress = mDeviceInfoList.get(position).getIpAddress();
        intent.putExtra(getString(R.string.ipAddress), ipAddress);

        // For USB, change the target to "USB:".
        // The USB port changes each time the printer restarts.
        // Please refer to the manual for details.
        HashMap<String, String> item  = mSimpleAdapterData.get(position);
